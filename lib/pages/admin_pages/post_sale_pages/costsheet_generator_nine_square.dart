...
class CostGenerators extends StatefulWidget {
  ...
  const CostGenerators({super.key, this.lead, this.flat, this.allInclusive});

  @override
  State<CostGenerators> createState() => _CostGeneratorState();
}

class _CostGeneratorState extends State<CostGenerators> {
  ...
  Future<void> generatePdf() async {
    ...
    final pdfName = 'Cost Sheet 02 - Unit ${unitNoController.text}.pdf';
      ...
      children: [
        ...
        pw.Padding(
          ...
          child: pw.Align(
              ...
              child: pw.Text(showDash ? "-":formatCurrency(amount), style: textStyle)),
        ),
        rounded != null
            ? pw.Padding(
                padding: const pw.EdgeInsets.all(2),
