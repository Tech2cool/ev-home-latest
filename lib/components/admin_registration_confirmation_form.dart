...
class AdminRegistrationConfirmationForm extends StatefulWidget {
  final int stage;

  final TextEditingController otpController;

  const AdminRegistrationConfirmationForm({
    super.key,
  ...
  @override
  State<AdminRegistrationConfirmationForm> createState() =>
      _AdminRegistrationConfirmationFormState();
}

class _AdminRegistrationConfirmationFormState
    extends State<AdminRegistrationConfirmationForm> {
