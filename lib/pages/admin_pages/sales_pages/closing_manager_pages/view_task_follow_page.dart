...
class ViewTaskFollowPage extends StatefulWidget {
  const ViewTaskFollowPage({super.key});

  @override
  _ViewTaskFollowPageState createState() => _ViewTaskFollowPageState();
}

class _ViewTaskFollowPageState extends State<ViewTaskFollowPage> {
