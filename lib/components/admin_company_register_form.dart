...
class AdminCompanyRegisterForm extends StatefulWidget {
  final int stage;
  ...
  const AdminCompanyRegisterForm({
    super.key,
    required this.stage,
  ...
  @override
  State<AdminCompanyRegisterForm> createState() =>
      _AdminCompanyRegisterFormState();
}

class _AdminCompanyRegisterFormState extends State<AdminCompanyRegisterForm>
