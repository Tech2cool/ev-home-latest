...
// import 'package:go_router/go_router.dart';
// import 'package:provider/provider.dart';
// import 'analyser_internal_tagging_details.dart';

// class AnalyserTaggingListPage extends StatefulWidget {
//   final String status;
//   const AnalyserTaggingListPage({super.key, required this.status});

//   @override
//   State<AnalyserTaggingListPage> createState() =>
//       _AnalyserTaggingListPageState();
// }

// class _AnalyserTaggingListPageState extends State<AnalyserTaggingListPage> {
//   bool isLoading = false;
//   String searchQuery = '';
//   List<Lead> leads = [];
//   bool isFetchingMore = false;
...
//   List<Lead> getLeads(List<Lead> leads, String status) {
//     if (status == "Approved") {
...
//       leads = []; // Clear current list to avoid duplicates
//     });
...
//   // Fetch more leads for pagination
...
//       setState(() {
//         isFetchingMore = true;
//         currentPage++; // Increment page for fetching more
//       });
...
//   @override
//   Widget build(BuildContext context) {
//     final filteredLeads = getLeads(leads, widget.status);
...
//                         searchQuery = query;
//                       });
//                       getLeads2(); // Fetch leads on new search query
//                     });
//                   },
//                   decoration: InputDecoration(
//                     labelText: 'Search Lead',
...
//                           MaterialPageRoute(
//                             builder: (context) =>
//                                 AnalyserInternalTaggingDetails(
//                               lead: lead,
//                             ),
//                           ),
//                         );
