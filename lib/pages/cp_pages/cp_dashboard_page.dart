...
//   final Lead? lead;
//   const LineChartDemo({super.key, this.lead});
...
//   Future<void> _fetchLeadGraph() async {
//     final settingProvider = Provider.of<SettingProvider>(
//       context,
//       listen: false,
//     );

//     final response= await settingProvider.getleadsChannelPartnerGraphById(
//           settingProvider.loggedChannelPartner?.id ?? "");
//     setState(() {
...
//       listen: false,
//     );
//         final response=  settingProvider.getleadsChannelPartnerGraphById(
//           settingProvider.loggedChannelPartner?.id ?? "");
...
//   final Lead? lead;
//   const PieChartDemo({super.key, this.lead});
...
//     final response = await settingProvider.searchLeadChannelPartner(
//       settingProvider.loggedChannelPartner!.id!,
//     );
...
//                   ),
//                   Text(
//                     '${approvedCount + pendingCount + rejectedCount}', // Total leads count
//                     style: const TextStyle(
//                       fontSize: 14,
//                       fontWeight: FontWeight.bold,
//                       color: Color(0xFF042630),
