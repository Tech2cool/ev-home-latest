...
class AdminPersonalRegisterForm extends StatefulWidget {
  ...
  const AdminPersonalRegisterForm({
    super.key,
  ...
  @override
  _AdminPersonalRegisterFormState createState() =>
      _AdminPersonalRegisterFormState();
}

class _AdminPersonalRegisterFormState extends State<AdminPersonalRegisterForm>
