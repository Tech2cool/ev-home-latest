...
//
  ...
  Widget build(BuildContext context) {
    ...
    final filteredDesignations = departments.where((designation) {
      final nameLower = designation.department.toLowerCase();
                                ...
                                Expanded(
                                  child: ElevatedButton(
                                    ...
                                    onPressed: () async {
                                      ...
                                      try {
                                        await settingProvider.addDepartment(
                                          nameController.text,
                                        );
                                        setState(() {
                                          isLoading = false;
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return ListTile(
                                ...
                                title: Text(designation.department),
  ...
  void _editDepartmemt(Department department) {
    setState(() {
      nameController.text = department.department;
    });
                      ...
                      Expanded(
                        child: ElevatedButton(
                          ...
                          onPressed: () async {
                            ...
                            try {
                              await settingProvider.updateDepartment(
                                department.id,
                                nameController.text,
                              );
                              setState(() {
  ...
  void _deleteDesignation(Department department) {
    showDialog(
      context: context,
        ...
        actions: [
          ...
          TextButton(
            onPressed: () async {
              ...
              try {
                await settingProvider.deleteDepartment(department.id);
                setState(() {
                  isLoading = false;
                });
              } catch (e) {
