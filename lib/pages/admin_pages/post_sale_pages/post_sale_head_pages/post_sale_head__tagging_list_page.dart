...
class PostSaleHeadTaggingListPage extends StatefulWidget {
  final String status;
  const PostSaleHeadTaggingListPage({super.key, required this.status});

  @override
  State<PostSaleHeadTaggingListPage> createState() =>
      _PostSaleHeadTaggingListPageState();
}

class _PostSaleHeadTaggingListPageState
    extends State<PostSaleHeadTaggingListPage> {
  ...
  Future<void> getLeads({bool resetPage = false}) async {
    ...
    final visitsResp = await settingProvider.getPostSaleLead(
      searchQuery,
      currentPage,
      10,
    );
