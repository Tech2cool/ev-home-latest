import 'package:ev_homes/pages/admin_pages/sales_pages/closing_manager_pages/first_call_details.dart';
import 'package:flutter/material.dart';

class TaskFirstCall extends StatefulWidget {
  @override
  _TaskFirstCallState createState() => _TaskFirstCallState();
}

class _TaskFirstCallState extends State<TaskFirstCall> {
                ...
                return InkWell(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => FirstCallDetails(),
                      ),
                    );
                  },
                  child: Card(
