...
class _PaymentScheduleAndDemandLetterState extends State<PostSaleDemandLetter> {
          ...
          pw.Column(
            ...
            children: [
              ...
              _buildPdfBankDetails(
                'Axis Bank Limited (for Booking amount payment$remainingBase)',
              ...
              _buildPdfBankDetails(
                'IDBI Bank (for GST And TDS amount payment$remainingGst)',
                'Account Name:- E V Homes Construction Pvt.Ltd',
                '0123102000043254',
                'IBKL0000123',
                'IDBI Bank',
  ...
  pw.Widget _buildPdfTable() {
    ...
    List<pw.TableRow> rows = [
      _buildPdfTableRow(['Particulars', 'Net Amount', 'CGST/SGT', 'Total'],
          isHeader: true),
      _buildPdfTableRow([
        'Amount due + GST @ 5%',
      ...
      _buildPdfTableRow([
        ...
        currencyFormat.format(receivedBase + receivedGst)
      ]),
      _buildPdfTableRow([
