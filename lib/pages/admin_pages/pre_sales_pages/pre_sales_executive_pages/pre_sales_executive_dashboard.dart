                    ...
                    children: [
                      ...
                      Expanded(
                        child: GestureDetector(
                          onTap: () {
                            GoRouter.of(context).push(
                              "/pre-sales-executive-lead-list/visit/${widget.id ?? settingProvider.loggedAdmin!.id!}",
                            );
                          },
                          child: MyCard(
                      ...
                      Expanded(
                        child: GestureDetector(
                          onTap: () {
                            ...
                            GoRouter.of(context).push(
                              "/pre-sales-executive-lead-list/booking/${widget.id ?? settingProvider.loggedAdmin!.id!}",
                            );
                          },
                          child: MyCard(
